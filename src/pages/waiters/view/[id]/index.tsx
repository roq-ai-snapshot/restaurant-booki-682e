            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('waiter', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/waiters/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                <FormListItem
                  label="Shift Start"
                  text={data?.shift_start ? format(parseISO(data?.shift_start as unknown as string), 'dd-MM-yyyy') : ''}
                />

                <FormListItem
                  label="Shift End"
                  text={data?.shift_end ? format(parseISO(data?.shift_end as unknown as string), 'dd-MM-yyyy') : ''}
                />

                <FormListItem label="Uniform Number" text={data?.uniform_number} />
