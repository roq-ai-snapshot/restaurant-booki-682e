...
export function RestaurantListPage(props: RestaurantListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getRestaurants({
        relations: ['user', 'chef.count', 'menu.count', 'table_reservation.count', 'waiter.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('table_reservation', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          ...
          accessorKey: 'table_reservation',
          cell: ({ row: { original: record } }: any) => record?._count?.table_reservation,
        }
      : null,
    hasAccess('waiter', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          ...
          header: 'Waiter',
          accessorKey: 'waiter',
          cell: ({ row: { original: record } }: any) => record?._count?.waiter,
        }
      : null,
