...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Chefs', path: '/chefs', entity: 'chef', service: AccessServiceEnum.PROJECT, icon: FiFeather },
    ...
    { name: 'Waiters', path: '/waiters', entity: 'waiter', service: AccessServiceEnum.PROJECT, icon: FiCoffee },
