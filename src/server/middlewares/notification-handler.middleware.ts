...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'order_placed.create': { roles: ['owner', 'chef', 'waiter'], key: 'order_id', tenantPath: [], userPath: [] },
  'feedback_given.create': { roles: ['owner'], key: 'feedback_id', tenantPath: [], userPath: [] },
  'inventory_updated.update': { roles: ['owner', 'chef'], key: 'inventory_id', tenantPath: [], userPath: [] },
};
